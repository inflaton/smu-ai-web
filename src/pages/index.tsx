...
export default function Home() {
  ...
  async function handleSubmit(e: any) {
    if (loading) {
      console.log('handleSubmit: loading is true - quitting ... ');
      return;
    }
    e.preventDefault();
      ...
      <Layout>
        <div className="mx-auto flex flex-col gap-4">
          <h1 className="text-2xl font-bold leading-[1.1] tracking-tighter text-center">
            {process.env.NEXT_PUBLIC_TITLE || 'Chat with Llama-2'}
          </h1>
        ...
        <footer className="m-auto p-4 text-center">
          <a
            ...
            target="_blank"
          >
            {process.env.NEXT_PUBLIC_FOOTER1 || 'Powered by Llama-2, LangChain and'}
            <br />
            {process.env.NEXT_PUBLIC_FOOTER2 || 'HuggingFace Transformers.'}
          </a>
        </footer>
      </Layout>
    </>
